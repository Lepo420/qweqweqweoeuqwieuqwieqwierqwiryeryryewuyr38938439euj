...
function chatBubbleInfo(sendInfo) {
            ...
            switch (c) {
                ...
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]),
                        null != a /* && -200 <= a && 200 >= a */ ? (n.A.rd.Xa(a),
                            this.ya.gm(a),
    ...
    u.mk = function () {
        ...
        ;
    u.$h = function (a, b) {
        return "" + window.location.origin + "/play/play?c=" + a + (b ? "&p=1" : "")
    }
        ;
    u.oo = function () {
        var a = n.A.fe.L()
    ...
    Da.N = "<div class='chatbox-view'><div data-hook='log' class='log'><p>Hack created by ᴸᵉᵖᵒ ᶜˡᵃᵖ ʸᵒᵘ ツ#0543</p></div><div class='autocompletebox' data-hook='autocompletebox'></div><div class='input'><input data-hook='input' type='text' /><button data-hook='send'>Send</button></div></div>";
